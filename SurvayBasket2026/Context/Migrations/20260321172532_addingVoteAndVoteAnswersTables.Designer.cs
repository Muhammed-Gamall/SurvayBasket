...
namespace SurvayBasket2026.Context.Migrations
{
    ...
    [Migration("20260321172532_addingVoteAndVoteAnswersTables")]
    partial class addingVoteAndVoteAnswersTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SurvayBasket2026.Entities.Answer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SurvayBasket2026.Entities.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SurvayBasket2026.Entities.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SurvayBasket2026.Entities.ApplicationUser", b =>
                {
                    b.OwnsMany("SurvayBasket2026.Entities.RefreshToken", "RefreshTokens", b1 =>
                        {
            ...
            modelBuilder.Entity("SurvayBasket2026.Entities.Poll", b =>
                {
                    b.HasOne("SurvayBasket2026.Entities.ApplicationUser", "CreatedBy")
                        .WithMany()
                        .HasForeignKey("CreatedById")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("SurvayBasket2026.Entities.ApplicationUser", "UpdatedBy")
                        .WithMany()
